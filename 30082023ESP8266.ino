...
const char* ssid = "JioFiber-xMxUU";
const char* password = "Ha5quaYahp0vao5p";
...
"<title>home</title>" \
"<style>"\
".button1  {padding: 10px 29px;}"\
".button4  {padding: 10px 33px;}"\
".button5  {padding: 10px 35px;}"\
".button6  {padding: 10px 37px;}"\
".button7  {padding: 10px 26px;}"\
".button8  {padding: 10px 26px;}"\
".button9  {padding: 10px 27px;}"\
".button10 {padding: 10px 26px;}"\
".button11 {padding: 10px 26px;}"\
".button15 {padding: 10px 13px;}"\
".button16 {padding: 10px 4px;}"\
".button20 {padding: 10px 21px;}"\
"</style>"\
"</head>" \
"<body>" \
"<h1>Smart Home</h1>" \
...
"<table>" \
  "<tr>" \
    "<td><a href=\"/Switch1\"><button class=\"button1\">"+ switch1name +"<br />"+ switch1 +"</button></a></td>" \
    "<td><a href=\"/Switch2\"><button class=\"button4\">"+ switch2name +"<br />"+ switch2 +"</button></a></td>" \
    "<td><a href=\"/Switch4\"><button class=\"button5\">"+ switch4name +"<br />"+ switch4 +"</button></a></td>" \
  "</tr>" \
"</table>" \
"<table>" \
  "<tr>" \
    "<td><a href=\"FanOFF\"><button class=\"button6\">Fan<br />OFF</button></a></td>" \
    "<td><a href=\"/FanSpeed1\"><button class=\"button7\">Fan<br />Speed1</button></a></td>" \
    "<td><a href=\"/FanSpeed2\"><button class=\"button8\">Fan<br />Speed2</button></a></td>" \
  "</tr>" \
"</table>" \
"<table>" \
  "<tr>" \
    "<td><a href=\"/FanSpeed3\"><button class=\"button9\">Fan<br />Speed3</button></a></td>" \
    "<td><a href=\"/FanSpeed4\"><button class=\"button10\">Fan<br />Speed4</button></a></td>" \
    "<td><a href=\"/FanSpeed5\"><button class=\"button11\">Fan<br />Speed5</button></a></td>" \
  "</tr>" \
"</table>" \
"<table>" \
  "<tr>"
    "<td><a href=\"/All\"><button class=\"button15\">ALL Devices<br />" + All + "</button></a></td>" \
    "<td><a href=\"/AcON\"><button class=\"button16\">Air Conditioner<br />ON / OFF</button></a></td>" \
    "<td><a href=\"/FL\"><button class=\"button20\">Fan Light<br />" + FL + "</button></a></td>" \
  "</tr>" \
"</table>" \
"</body>" \
"</html>" \
...
".container{text-align: center; margin-top: 360px;}"\
".btn {border: 1px solid 3498db; background: none; padding: 10px 20px; font-size: 20px; margin:10px}"\
"</style>"\
"</head>" \
"<body>" \
"<h1>Smart Home</h1>" \
...
"<div class=\"container">"\
  "<table>" \
    "<thead>" \
        "<tr>" \
          "<th><a href=\"/ACON\"><button class=\"btn btn1\">ON / OFF</button></a></th>" \
          "<th><a href=\"/ACTurbo\"><button class=\"btn btn2\"> Turbo  </button></a></th>" \
          "<th><a href=\"/ACDim\"><button class=\"btn btn3\">Dim</button></a></th>" \
        "</tr>" \
     "</thead>" \
      "<table>" \
        "<tr>" \
          "<td><a href=\"/AcPowerSaver\"><button class=\"button24\">Power Saver</button></a></td>" \
          "<td><a href=\"/AcWinter\"><button class=\"button25\">Winter Mode</button></a></td>" \
          "<td><a href=\"/AC30\"><button class=\"button26\">30</button></a></td>" \
        "</tr>" \
      "</table>" \
      "<table>" \
        "<tr>" \
          "<td><a href=\"/AC29\"><button class=\"button27\">29</button></a></td>" \
          "<td><a href=\"/AC28\"><button class=\"button28\">28</button></a></td>" \
          "<td><a href=\"/AC27\"><button class=\"button29\">27</button></a></td>" \
        "</tr>"
      "</table>" \
      "<table>" \
        "<tr>"
          "<td><a href=\"/AC26\"><button class=\"button30\">26</button></a></td>" \
          "<td><a href=\"/AC25\"><button class=\"button31\">25</button></a></td>" \
          "<td><a href=\"/AC24\"><button class=\"button32\">24</button></a></td>" \
        "</tr>" \
  "</table>" \
"</main>" \
"</body>" \
...
void Allfunction(){
  if (All == "ON" || switch1 == "ON" || switch2 == "ON" || switch4 == "ON" || Fan != "OFF" || AC != "OFF") { // All off
    All = "OFF";
    switch1 = "OFF";
    switch2 = "OFF";
    Fan = "OFF";
